...
<?php
//This file executes the SQL queries for adding a new device to the databse
...
if(isset($_POST['sbt'])){
   ...
   //if fields are empty
    if(empty($_POST['AssetTag']) && empty($_POST['Model'])&& empty($_POST['User'])){
        echo "Error: All fields are required: If device has no assigned user change User to: N/A\n";
        $error = "1";
    }
